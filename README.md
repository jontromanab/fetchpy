...
Motion plannaning for whole body can be generated by https://github.com/jontromanab/fetchwbp



## Demo ##
To view the capabilites of Fetchpy, the best starting point is pose_control.py. Run your roscore, start the real robot or simulated robot in gazebo (roslaunch fetch_gazebo simulation.launch) and in a different terminal:
```
